...
import uacj.mx.app05_appnavigator.ui.controladores.navegaciones.Canal
...
@Composable
fun PantallaConfiguracion(modificador: Modifier = Modifier, controlador_de_navegacion: NavHostController){
